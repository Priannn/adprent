    ...
    <section class="max-w-5xl mx-auto p-6 relative">
        ...
        <div id="mobile-menu" class="hidden absolute top-20 left-6 right-6 bg-white shadow-xl rounded-xl p-6 flex-col space-y-4 z-50 md:hidden border border-slate-100">
            ...
            <div class="bg-[#003049] rounded-full py-3 px-6 text-white font-bold text-center mt-2">
                <button class="w-full"><a>Profile</a></button>
            </div>
        </div>
    </section>
        ...
        <section class="mt-20 md:mt-28">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
                ...
                <div class="space-y-3 p-4 shadow-xl rounded-xl">
                    <img src="{{ asset('images/mobil/example.png') }}" class="w-full">
                    <h1 class="font-bold">Toyota Fortuner</h1>
                    <h1 class="text-[#D62828] font-semibold text-xl">IDR 1.000.000<span class="text-[10px] text-slate-500">/hari</span></h1>
                    <div class="flex items-center space-x-2">
                        <div class="flex">
                            <img src="{{ asset('images/icon/bahanbakar.svg') }}" alt="" class="w-3">
                            <h1 class="ml-2 text-sm text-slate-400">Bensin</h1>
                        </div>
                        <div class="flex">
                            <img src="{{ asset('images/icon/transmisi.svg') }}" alt="" class="w-3">
                            <h1 class="ml-2 text-sm text-slate-400">Matic</h1>
                        </div>
                        <div class="flex">
                            <img src="{{ asset('images/icon/seat.svg') }}" alt="" class="w-3">
                            <h1 class="ml-2 text-sm text-slate-400">8</h1>
                        </div>
                    </div>
                    <div class="flex gap-3 mt-4">
                        <button class="bg-[#003049] text-[10px] text-white py-2 px-3 rounded-full font-semibold flex-1">Book Sekarang</button>
