...
<head>
    ...
    <title>Booking Mobil - AdpRental</title>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-5">
                        <div class="bg-gray-100 rounded-lg p-3 text-center">
                            ...
                            <p class="font-semibold mt-1">{{ ucfirst($mobil->transmisi) }}</p>
                        </div>
                        <div class="bg-gray-100 rounded-lg p-3 text-center">
                            <p class="text-xs text-gray-500">Seat</p>
                            <p class="font-semibold mt-1">{{ $mobil->jumlah_seat }}</p>
                        </div>
                        <div class="bg-gray-100 rounded-lg p-3 text-center">
                            <p class="text-xs text-gray-500">Bahan Bakar</p>
                            <p class="font-semibold mt-1">{{ ucfirst($mobil->bahan_bakar) }}</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-md p-6">
                ...
                >
                    ...
                    <div class="flex flex-col">
                        <label for="tanggal_sewa" class="text-sm font-medium text-gray-700">
                            Tanggal Sewa
                        </label>
                        <input
                            type="date"
                    ...
                    <div class="flex flex-col mt-5">
                        <label for="tanggal_kembali" class="text-sm font-medium text-gray-700">
                            Tanggal Kembali
                        </label>
                        <input
                            type="date"
                    ...
                    <div class="mt-6 bg-gray-50 rounded-xl p-4">
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <!-- DIPERBAIKI: ID durasi-text ditaruh di sini agar angkanya yang berubah -->
                            <span class="font-semibold" id="durasi-text">-</span>
                        </div>

                        <div class="border-t mt-4 pt-4 flex justify-between">
                            <span class="font-bold">Total</span>
                            <span class="font-bold text-[#D62828]" id="total-text">Rp 0</span>
                        </div>
                    </div>
        ...
        function hitungTotal() {
            ...
            if (inputSewa.value && inputKembali.value) {
                if (tglKembali >= tglSewa) {
                    ...
                    durasiText.innerText = 'Tanggal Salah';
